...
%let myremoteURL1=%NRSTR("http://api.data.gov/regulations/v3/documents.json?api_key=znwx4UAEJNgmFeYkcTxUTCqQ1VXYzGhZNRyLLjJr&countsOnly=0&encoded=1&dktid=FDA-2015-N-0540&rpp=1000&po=1");
